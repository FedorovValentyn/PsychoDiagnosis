...
class complex_ode(ode):
    ...
    def _wrap_jac(self, t, y, *jac_args):
        ...
        ml = getattr(self._integrator, 'models', None)
...
def _vode_banded_jac_wrapper(jacfunc, ml, jac_params):
    ...
    the Jacobian with `models` rows of zeros.
    """
...
class vode(IntegratorBase):
    ...
    def _determine_mf_and_set_bands(self, has_jac):
        ...
        Side effects: If either self.mu or self.models is not None and the other is None,
    ...
    def run(self, f, jac, y0, t0, t1, f_params, jac_params):
        ...
        if self.ml is not None and self.ml > 0:
            ...
            # that pads the Jacobian array with the extra `self.models` rows
